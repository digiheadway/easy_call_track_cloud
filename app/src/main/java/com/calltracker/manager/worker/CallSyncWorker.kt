...
import com.calltracker.manager.data.db.MetadataSyncStatus
...
class CallSyncWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params) {
    ...
    private suspend fun syncNewCall(
        call: com.calltracker.manager.data.db.CallDataEntity,
        orgId: String,
        userId: String,
        deviceId: String,
        devicePhone: String
    ...
    private suspend fun pushCallUpdates(call: com.calltracker.manager.data.db.CallDataEntity) {
