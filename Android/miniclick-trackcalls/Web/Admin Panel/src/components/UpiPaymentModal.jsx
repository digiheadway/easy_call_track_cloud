                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="p-4 rounded-2xl bg-amber-50  border border-amber-200  flex gap-3 items-start">
                                            ...
                                            <div className="space-y-1">
                                                <p className="text-[10px] font-black text-amber-700  uppercase tracking-widest">Important Notice</p>
                                                <p className="text-[11px] text-amber-800  font-medium leading-relaxed">
                                                    Your plan will be <span className="font-bold">activated instantly</span> after entering the UTR. However, your payment will be verified within 24 hours. <span className="font-bold text-red-600 ">If no payment is found or UTR is invalid, your plan will be cancelled and reverted.</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
