            ...
            <nav className="w-full p-6 z-20">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    ...
                    <div className="hidden sm:block text-sm text-gray-500 ">
                        Already have an account? <Link to="/login" className="text-brand-600  hover:text-brand-500  font-medium ml-1">Log in</Link>
                    </div>
                </div>
            </nav>

            <main className="flex-grow flex items-center justify-center px-4 py-10 relative z-10">
                <div className="w-full max-w-md p-8 sm:p-10 rounded-3xl shadow-2xl bg-white  backdrop-blur-md border border-gray-100 ">

                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold mb-2 text-gray-900 ">Create Account</h1>
                        <p className="text-gray-500 ">Start your 3-day free trial today</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-start gap-3 mt-2">
                            <input type="checkbox" id="terms" className="mt-1 w-4 h-4 rounded border-gray-300  text-brand-600  focus:ring-brand-500 bg-gray-50 " />
                    ...
                    <div className="mt-8 text-center sm:hidden">
                        <p className="text-gray-500  text-sm">
                            ...
                            <Link to="/login" className="text-brand-600  font-semibold hover:text-brand-500  transition-colors">Log in</Link>
                        </p>
                    </div>
                </div>
            </main>
