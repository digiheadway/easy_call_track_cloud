...
switch ($method) {
    ...
    case 'POST':
        ...
        Validator::required($data, ['name', 'phone']);
    ...
    case 'PUT':
        ...
        if (isset($data['phone'])) $updates[] = "phone = '" . Database::escape(Validator::phone($data['phone'])) . "'";
        if (isset($data['status'])) $updates[] = "status = '" . Database::escape($data['status']) . "'";
        if (isset($data['device_id'])) $updates[] = "device_id = '" . Database::escape($data['device_id']) . "'";
