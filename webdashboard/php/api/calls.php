...
switch ($method) {
        ...
        if ($action === 'stats') {
            ...
            if ($search) {
                ...
                if ($cleanSearch && is_numeric($cleanSearch)) {
                    $where[] = "(c.caller_name LIKE '%$search%' OR c.caller_phone LIKE '%$cleanSearch%' OR co.name LIKE '%$search%')";
                } else {
                    $where[] = "(c.caller_name LIKE '%$search%' OR co.name LIKE '%$search%')";
                }
            }
    ...
    case 'POST':
        ...
        $callerPhone = Database::escape(Validator::phone($data['phone_number']));
