...
export default function Recordings({ organizationId }: RecordingsProps) {
    ...
    const [stats, setStats] = useState<RecordingStats>({ total_count: 0, total_size: '0 B', total_duration: '0:00' });
    ...
    const loadRecordings = async () => {
        try {
            ...
            if (response.status && response.data) {
                ...
                setRecordings(data.map((rec: any) => ({
                    ...rec,
    ...
    const loadStats = async () => {
        try {
            const response = await api.getRecordingStats();
            if (response.status && response.data) {
    ...
    return (
        <div className="page-container">
            ...
            <div className="recording-stats">
                ...
                <div className="stat-box">
                    <div className="stat-number">{stats.total_duration}</div>
            ...
            <div className="recordings-grid">
                {loading && recordings.length === 0 ? (
                    <div className="col-span-full text-center py-8 text-muted">Loading recordings...</div>
                ) : recordings.length === 0 ? (
                    <div className="col-span-full text-center py-8 text-muted">No recordings found</div>
                ) : (
                        ...
                        <div key={recording.id} className="recording-card card">
                            <div className="recording-header">
                                ...
                                <div className="recording-info">
                                    <div className="recording-title" title={recording.filename}>{recording.filename}</div>
                                    <div className="recording-meta">
                                        {recording.employee_name}
                                    </div>
                                </div>
                            </div>
