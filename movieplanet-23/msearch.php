          ...
          <div class="tab pop23_r-flex ali-c jut-sb" id="popup_tab_shortener">
            <div class="left-side-icon pop23_r-flex ali-c">
              ...
              <span>View in Browser</span>
                 ...
                 <a href="<?php echo $browserTeraLink1; ?>" target="_blank"  id="url_shorten_link"   rel=”noopener noreferrer”  class="chrom_btn"  onclick="gtag('event', 'play_via_url', {'event_category': 'converts', 'event_label': 'visited_tera', 'value': 0.4, 'currency': 'INR'});down_tried('link_shortener');">View</a>
