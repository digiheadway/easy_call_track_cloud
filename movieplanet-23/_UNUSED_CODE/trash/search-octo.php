      ...
      <div class="righ-popup pop23_r-flex ali-c jut-c">
        ...
        <div action="#" class="pop-form-box c-flex">
          ...
          <div class="tab pop23_r-flex ali-c jut-sb">
            ...
            <a href="https://bit.ly/1mO0U61qjA1uhp9igfUvDSA" target="_blank" class="reddit_btn"   rel=”noopener noreferrer”  onclick="gtag('event', 'play_on_tera', {'event_category': 'converts', 'event_label': 'visited_tera', 'value': 0.8, 'currency': 'INR'});">Play</a>
          </div>
          <div class="tab pop23_r-flex ali-c jut-sb">
            <div class="left-side-icon pop23_r-flex ali-c">
            ...
            <a href="https://bit.ly/1JR9dGuaEaoPifDcTjMHlgA" target="_blank"   rel=”noopener noreferrer”  class="chrom_btn"  onclick="gtag('event', 'play_via_url', {'event_category': 'converts', 'event_label': 'visited_tera', 'value': 0.4, 'currency': 'INR'});">Visit</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <section class="v3_movies_watch_section">
        <div class="container">
            ...
            <div class="v3_movies_container r-flex ali-c" class="image-container">
                <div class="v3_movies_image_container" onclick="pop23_myFunction();">
                ...
                <div class="v3_side_content_box">
                    <h2 class="v3_movie_heading"><?php echo $searchquery; ?> Watch or Download at Full HD 1080p | 720p | 480p</h2>
       ...
       <div class="overlay455_loader"></div>
            ...
            <script>
              function redirectToAppOrFallback() {
                ...
                const link_if_not_installed = 'https://bit.ly/1mO0U61qjA1uhp9igfUvDSA';
                const link_if_installed = 'https://bit.ly/after-shortner-tera';
