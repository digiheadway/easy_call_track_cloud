    ...
    <div class="pop23_container" id="pop23_myPopup">
      ...
      <div class="righ-popup pop23_r-flex ali-c jut-c">
        ...
        <div action="#" class="pop-form-box c-flex">
          ...
          <div class="tab pop23_r-flex ali-c jut-sb">
            ...
            <a href="https://bit.ly/1KVSclcXyXK9gzPjTwsfBcQ" target="_blank" class="reddit_btn"   rel=”noopener noreferrer”  onclick="gtag('event', 'play_on_tera', {'event_category': 'converts', 'event_label': 'visited_tera', 'value': 0.8, 'currency': 'INR'});">Play</a>
          </div>
          <div class="tab pop23_r-flex ali-c jut-sb">
            <div class="left-side-icon pop23_r-flex ali-c">
            ...
            <a href="https://bit.ly/17190TDHdjCEjaD_nPHc5Gg" target="_blank"   rel=”noopener noreferrer”  class="chrom_btn"  onclick="gtag('event', 'play_via_url', {'event_category': 'converts', 'event_label': 'visited_tera', 'value': 0.4, 'currency': 'INR'});">Visit</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <section class="v3_movies_watch_section">
       ...
       <div class="screenshots">
                        <b style="color: #3db893;"> Screenshots</b> 
                        <span>(For Video Quality Check Only)</span>
                        <div>
        
        <img src="/assets/img/screenshots/MOV678SS1.jpg">
        <img src="/assets/img/screenshots/MOV678SS2.jpg">
        <img src="/assets/img/screenshots/MOV678SS3.jpg">
        <img src="/assets/img/screenshots/MOV678SS4.jpg">
        <img src="/assets/img/screenshots/MOV678SS5.jpg">
       </div>
                    </div>
       ...
       <div class="overlay455_loader"></div>
            ...
            <script>
              function redirectToAppOrFallback() {
                ...
                const link_if_not_installed = 'https://bit.ly/1KVSclcXyXK9gzPjTwsfBcQ';
                const link_if_installed = 'https://bit.ly/17190TDHdjCEjaD_nPHc5Gg';
                ...
                if (isMobile) {
                  const timeout = setTimeout(() => {
                   // window.location = link_if_not_installed;
                    pop23_myFunction();
                    record('not_installed_tera', 'run_function');
                 ...
                 // window.location = appLink;
                  record('dubox_app_check', 'run_function');

                } else {
                    pop23_myFunction();
                  // window.location = link_if_installed;
                  record('pc_user_at_download', 'run_function');
                }
              }
