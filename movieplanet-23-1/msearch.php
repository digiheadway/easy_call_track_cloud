<!DOCTYPE html>
    ...
    <head>
      ...
      if (!$searchquery) {
        echo '<script>alert("Try Searching Again");</script>';
        echo '<script>
        // GA4 Event Tracking Code
        gtag(\'event\', \'no_query_found\', {
            \'event_category\': \'Search\', 
            \'event_label\': \'No Query Found\'
        });
    </script>';
      ...
      ?>
      <title>
        <?php echo $searchquery; ?>  | <?php echo $titlesuffix; ?>
      </title>
    ...
    <div class="pop23_container show" id="pop23_myPopup">
      ...
      <div class="righ-popup pop23_r-flex ali-c jut-c">
        ...
        <div action="#" class="pop-form-box c-flex">
          <div class="form-heading">Watch or Download <?php echo $searchquery; ?> Via..</div>
          ...
          <div class="tab pop23_r-flex ali-c jut-sb" id="popup_tab_shortener">
            <div class="left-side-icon pop23_r-flex ali-c">
              ...
              <span>View in Browser</span>
                ...
                $tera_link = $browserTeraLink1 . '?' . http_build_query($tera_params, '', '&', PHP_QUERY_RFC3986);
                ?>
                 <a href="<?= $tera_link ?>" target="_blank"  id="url_shorten_link"   rel=”noopener noreferrer”  class="chrom_btn"  onclick="gtag('event', 'play_via_url', {'event_category': 'converts', 'event_label': 'visited_tera', 'value': 0.4, 'currency': 'INR'});down_tried('link_shortener');">View</a>

            <!-- <a href="/url_shortner.php?q=<?php echo $searchquery; ?>" target="_blank"  id="url_shorten_link"   rel=”noopener noreferrer”  class="chrom_btn"  onclick="gtag('event', 'play_via_url', {'event_category': 'converts', 'event_label': 'visited_tera', 'value': 0.4, 'currency': 'INR'});down_tried('link_shortener');">Open</a> -->
          </div>
           <div class="tab pop23_r-flex ali-c jut-sb" id="popup_tab_shortener3">
            <div class="left-side-icon pop23_r-flex ali-c">
              ...
              <span>Mirror Link 3</span>
                 ...
                 <a href="<?php echo $terawatch; ?>?title=<?php echo $searchquery; ?>+Full+Hd" target="_blank"  id="url_shorten_link"   rel=”noopener noreferrer”  class="chrom_btn"  onclick="gtag('event', 'play_via_url', {'event_category': 'converts', 'event_label': 'visited_tera', 'value': 0.4, 'currency': 'INR'});down_tried('link_shortener');">View</a>
      ...
      <section class="v3_movies_watch_section">
        <div class="container">
            <div class="v3_bradcamp_box r-flex ali-c">
                ...
                <span class="v3_movie_name_bradcamp">Movie53676.mp4 <?php // echo $searchquery; ?></span>
            </div>
            ...
            <div class="v3_movies_container r-flex ali-c" class="image-container">
                  ...
                  <div onclick="pop23_myFunction();" class="cur">  
                    ...
                    <div>
                      ...
                      <form action="<?php echo $func_search_url; ?>" class="hero_search_form" onsubmit="record('searched_from_not_this','123movies');" id="not_this_searchbox" style="display:none;">
                        <input type="search" name="q" id="hero_search" placeholder="Search Any Movie/Series/Show " value="<?php echo $searchquery; ?>">
                ...
                <div class="v3_side_content_box">
                    <h2 class="v3_movie_heading">Watch or Download <?php echo $searchquery; ?> at Full HD 1080p | 720p | 480p</h2>
                    ...
                    Get ready for an incredible experience with <?php echo $searchquery; ?>, a captivating masterpiece that is perfect for everyone. 
                    <!-- This amazing creation combines thrilling action, intriguing suspense, and heartfelt emotions to deliver a truly memorable viewing experience. With talented actors, stunning visuals, and a compelling story, <?php echo $searchquery; ?> has something for everyone to enjoy.  -->
                    Don't miss the chance to download <?php echo $searchquery; ?> and immerse yourself in a world of excitement and entertainment that will stay with you long after the credits roll. Get ready to be captivated by the magic of <?php echo $searchquery; ?>!
                    </p>
                    ...
                    <div class="v3_file_size">
                        <b>File Name: </b>
                        <span>Movie53676.mp4 <?php // echo $filename; ?> </span>
                    </div>
                    <div class="v3_file_size">
                        <b>File Size:</b>
                        <span>700 MB - 2.5GB</span>
                    </div>
                    <div class="v3_file_size">
                        <b>Screenshots:</b>
...
document.getElementById("header_search_box").value = "<?php echo $searchquery; ?>";
